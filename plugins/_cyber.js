...
const Lang = Language.getString('_cyber');

if (Config.WORKTYPE == 'private') {

    Cyber.addCommand({pattern: 'cyber ?(.*)', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
        ...
        if (match[1] === '') {
            ...
            await message.client.sendMessage(
                message.jid,'●▬▬▬ *WhatsCyber Private* ▬▬▬●\n\n' + CMD_HELP, MessageType.text
            );    
        } else {
            var CMD_HELP = '';
            Cyber.commands.map(
    ...
    Cyber.addCommand({pattern: 'cyber ?(.*)', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
